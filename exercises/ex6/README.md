...
You are an occasional user of SAP Analytics Cloud and an information seeker. You prefer using natural language to explore insights across various models. A conversational interface is essential to help you add customised content to your Stories.

### Objective

+ The goal is to understand how Joule’s conversational features within SAP Analytics Cloud can assist in creating new content, whether through copy-paste or exploring analytical insights generated by Joule. 
+ Additionally, it aims to clarify the difference in functionality when Joule is used outside versus inside SAP Analytics Cloud. When Joule operates inside SAP Analytics Cloud, it is referred to as Joule Analytical Insights.
